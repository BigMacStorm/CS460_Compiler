...
%token PERCENTtok FORWARD_SLASHtok UNARY_ASTERISKtok UNARY_MINUStok UNARY_PLUStok
%token RIGHT_ANGLEtok LEFT_ANGLEtok UNARY_ANDtok UP_CARROTtok PIPEtok QUESTION_MARKtok
%token ELIPSIStok UNARY_ASTERISKtok CLOSE_SQUAREtok OPEN_SQUAREtok CLOSE_PARENtok
